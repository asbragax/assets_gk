...
var handleMixedChart = function() {
	...
	var options = {
		...
		title: {
			text: 'XYZ - Stock Analysis (2017 - 2025)',
			align: 'left',
			offsetX: 110
		},
		xaxis: {
...
var handleBubbleChart = function() {
	...
	var options = {
		...
		series: [{
				name: 'Bubble1',
				data: generateData(new Date('11 Feb 2025 GMT').getTime(), 20, {
					min: 10,
					max: 60
				})
			},
...
var handleRadialBarChart = function() {
	...
	var chart = new ApexCharts(document.querySelector('#apex-radial-bar-chart'), options);
	chart.render();
};
