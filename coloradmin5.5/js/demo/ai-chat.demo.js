...
var toggleAiTabClick = function() {
	...
	$(document).on('click', '[data-toggle-ai-tab]', function(e) {
		...
		if (tabActive == 'aiChatPrev') {
			...
			$(elm).toggleClass('bg-body');
			$('[data-toggle-ai-tab="aiChatPrev"]').not(this).closest('div').removeClass('bg-body');
		} else {
			$('[data-toggle-ai-tab="aiChatPrev"]').closest('div').removeClass('bg-body');
